        ...
        <div className={isMobile ? 'data-box-mobile' : 'data-box'}>
            {(invoice && items && client) ? (
                <>
                    ...
                    <DataField description='Data utworzenia faktury' text={invoice.creationDate}/>
                    <DataField description='Data wykonania usługi' text={invoice.dateOfService}/>
                    <DataField description='Wartość netto całej faktury' text={`${invoice.netValueOfTheEntireInvoice.toFixed(2)} zł`}/>
                    <DataField description='Wartość podatku całej faktury' text={`${invoice.tax.toFixed(2)} zł`}/>
                    <DataField description='Wartość brutto całej faktury' text={`${invoice.grossValueOfEntireInvoice.toFixed(2)} zł`}/>
                    <DataField description='Metoda płatności' text={invoice.methodOfPayment}/>
                    <DataField description='Termin płatności' text={invoice.dueDate}/>
                    <DataField description='Osoba wystawiająca fakturę' text={invoice.personCreatingInvoice}/>
                    <DataField description='Miejscowość wystawienia faktury' text={invoice.place}/>
