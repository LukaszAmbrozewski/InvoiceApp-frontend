...
export const PaymentForm = (props: Props) => {
    ...
    const addPayment = async (values: InvoicePayment) => {
        if(props.paymentMethod === ''){
            ...
            console.log(param.invoiceId, props.paymentMethod, values.dueDate, values.accountNumber)
            ...
            response.isSuccess ? navigate(`/invoice-add-item/${param.invoiceId}`) : navigate('/error');
        }
    }
                ...
                {({errors, touched}) => (
                    <Form className='form-box'>
                        ...
                        <Field
                            ...
                            error={Boolean(errors.accountNumber) && Boolean(touched.accountNumber)}
                            helperText={Boolean(touched.accountNumber) && errors.accountNumber}
                        />
