            ...
            {client ? (<>
                    ...
                    <div className='invoice-main-info-box invoice-modify-box'>
                        ...
                        <div className='icon-box'>
                            <div className='invoice-icon' onClick={() => showInvoice(props.invoice.id)}><VisibilityIcon/></div>
                            <div className='invoice-icon invoice-delete-icon' onClick={() => removeInvoice(props.invoice.id)}><DeleteIcon/></div>
                        </div>
                    </div>
                </>
            ) : null}
