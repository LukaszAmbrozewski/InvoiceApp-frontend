        ...
        <div className="full-product-info-box">
          <div className="main-product-box">
            <div className="main-product-info-description">
              ...
              <p className="product-main-info">{`${props.oneItemInfo.totalGrossValue.toFixed(
                2
              )} zł`}</p>
            </div>
            <div className="item-icons-box">
              <div
                ...
                onClick={() => removeItem(props.oneItemInfo.id)}
              >
                <DeleteIcon />
              </div>
          ...
          <div>
            ...
            <p className="product-info">{`${props.oneItemInfo.netValue.toFixed(
              2
            )} zł`}</p>
            ...
            <p className="product-info">{`${props.oneItemInfo.taxValue.toFixed(
              2
            )} zł`}</p>
            <p className="product-description">Łączna wartość brutto</p>
            <p className="product-info">{`${props.oneItemInfo.totalGrossValue.toFixed(
              2
            )} zł`}</p>
          </div>
        </div>
