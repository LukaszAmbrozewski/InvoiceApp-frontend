...
export const ClientSelect = (props: Props) => {
    ...
    return (
        ...
        >
            <InputLabel id="demo-simple-select-filled-label">Wybierz kontrahenta z listy</InputLabel>
            <Select
            ...
            >
                {props.clientsList.map(client => (
                        <MenuItem value={client.id} key={client.id}>{client.companyName}</MenuItem>
                    )
                )}
            </Select>
        </FormControl>
