...
export const RegisterBox = () => {
  ...
  const [typeCheckPassword, setTypeCheckPassword] =
  ...
  const changeVisibilityCheckPassword = () => {
    setTypeCheckPassword(
      typeCheckPassword === "password" ? "string" : "password"
    );
  };
        ...
        {({ errors, touched }) => (
          <Form className="auth-box">
            ...
            <Field
              ...
              error={
                Boolean(errors.checkPassword) && Boolean(touched.checkPassword)
              }
              helperText={
                Boolean(touched.checkPassword) && errors.checkPassword
              }
            />
