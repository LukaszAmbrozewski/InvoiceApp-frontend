                ...
                {({errors, touched}) => (
                    <Form className='form-box'>
                        ...
                        <Field
                            ...
                            error={Boolean(errors.creationDate) && Boolean(touched.creationDate)}
                        ...
                        <Field
                            ...
                            error={Boolean(errors.dateOfService) && Boolean(touched.dateOfService)}
                            helperText={Boolean(touched.dateOfService) && errors.dateOfService}
                        />
                        ...
                        <Field
                            ...
                            error={Boolean(errors.personCreatingInvoice) && Boolean(touched.personCreatingInvoice)}
                            helperText={Boolean(touched.personCreatingInvoice) && errors.personCreatingInvoice}
                        />
