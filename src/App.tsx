  ...
  return (
    <div className="App">
      <Routes>
        <Route
          path="/client-add"
          element={ctx.id === "" ? <Login /> : <ClientAdd />}
        />
        <Route
          path="/client-added"
          element={ctx.id === "" ? <Login /> : <ClientAdded />}
        />
        <Route
          path="/client-patch/:clientPatchId"
          element={ctx.id === "" ? <Login /> : <ClientPatch />}
        />
        <Route
          path="/clients-list"
          element={ctx.id === "" ? <Login /> : <ClientsList />}
        />
        <Route
          path="/history"
          element={ctx.id === "" ? <Login /> : <History />}
        />
        <Route
          path="/invoice-add"
          element={ctx.id === "" ? <Login /> : <InvoiceAdd />}
        />
        <Route
          path="/invoice-add-item/:invoiceId"
          element={ctx.id === "" ? <Login /> : <InvoiceAddItem />}
        />
        <Route
          path="/invoice-payment/:invoiceId"
          element={ctx.id === "" ? <Login /> : <InvoicePayment />}
        />
        <Route
          path="/invoices-list"
          element={ctx.id === "" ? <Login /> : <InvoicesList />}
        />
        <Route
          path="/invoice-summary"
          element={ctx.id === "" ? <Login /> : <InvoiceSummary />}
        />
        ...
        <Route
          path="/statistics"
          element={ctx.id === "" ? <Login /> : <Statistics />}
        />

        <Route
          path="/user-patch"
          element={ctx.id === "" ? <Login /> : <UserPatch />}
        />
        ...
        <Route
          path="/user-info"
          element={ctx.id === "" ? <Login /> : <UserInfo />}
        />
        <Route
          path="/invoice-added-item/:invoiceId"
          element={ctx.id === "" ? <Login /> : <InvoiceAddedItem />}
        />
        <Route
          path="/invoice-summary/:invoiceId"
          element={ctx.id === "" ? <Login /> : <InvoiceSummary />}
        />
